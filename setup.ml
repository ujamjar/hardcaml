...
(* OASIS_START *)
(* DO NOT EDIT (digest: cdc6a961e99bce1f795658cb00dbdb69) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "hardcaml";
               ...
               Flag
                 ({
                   ...
                   {
                      flag_description =
                        Some "Build javascript utility library";
                      flag_default = [(OASISExpr.EBool true, false)]
                   });
               Library
                 ({
                     cs_name = "HardCamlDynlink";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {
                      lib_modules = ["Sim_provider"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "HardCaml";
                      lib_findlib_name = Some "dynlink";
                      lib_findlib_containers = []
                   });
               Library
                 ({
               ...
               SrcRepo
                 ({
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/ujamjar/hardcaml.git";
                      src_repo_browser =
                        Some "https://github.com/ujamjar/hardcaml";
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\249|\239\250-,\166\231\178\r\233\232R\143\250\201";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
